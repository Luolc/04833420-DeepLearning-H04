...
def train(args, teacher_network):
    ...
    with g1.as_default():
        ...
        loss = tf.losses.softmax_cross_entropy(label_onehot, logits) + args.temperature ** 2 * \
               tf.losses.softmax_cross_entropy(target_label_onehot, logits / args.temperature) + loss_reg
